...
- [ ] 1.1 Create room — add invalidation after success
...
- [ ] 1.2 Edit room — add invalidation after success
...
- [ ] 1.3 Change room status — add dashboard invalidation
...
- [ ] 2.1 Create tenant — add invalidation after success
...
- [ ] 2.2 Edit tenant — add dashboard invalidation
...
- [ ] 2.3 Assign room to tenant — add dashboard invalidation
...
- [ ] 2.4 Move out tenant — add balance/dashboard/tenant/payments invalidation
...
- [ ] 3.1 Create payment — add dashboard and balance invalidation
...
- [ ] 3.2 Create expense — add dashboard invalidation
...
- [ ] 3.3 Edit expense — add dashboard invalidation
...
- [ ] 4.1 Delete property — add dashboard invalidation when applicable
