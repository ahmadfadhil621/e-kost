...
This skill covers **step 3** of the feature development workflow: validating that tests are meaningful before they become the source of truth for implementation. For the full workflow, see `.claude/rules/testing.md`.
...
3. **Gate 3: Review checklist** -- Walk through the checklist in `.claude/rules/test-quality-gates.md`
...
After Gates 1 and 2 pass, walk through the review checklist defined in `.claude/rules/test-quality-gates.md`. This catches semantic issues that automation and fault injection cannot.
...
3. `.claude/rules/test-quality-gates.md` -- Gate 3 review checklist
